...
~~~start-file~~~ "ucs4-utf8"
	...
	--assert (as byte! 0) = utf8/byte1
	--assert (as byte! 0) = utf8/byte2
	--assert (as byte! 0) = utf8/byte3
	--assert (as byte! 0) = utf8/byte4
	
	--test-- "ucs4-utf8-2"
		utf8: PWAW-ucs4-utf8 10
	--assert (as byte! 10) = utf8/byte1
	--assert (as byte! 0) = utf8/byte2
	--assert (as byte! 0) = utf8/byte3
	--assert (as byte! 0) = utf8/byte4
	...
	--assert (as byte! C4h) = utf8/byte1
	--assert (as byte! 80h) = utf8/byte2
	--assert (as byte! 0) = utf8/byte3
	--assert (as byte! 0) = utf8/byte4
	
	--test-- "ucs4-utf8-6"
		utf8: PWAW-ucs4-utf8 07FFh
	--assert (as byte! DFh) = utf8/byte1
	--assert (as byte! BFh) = utf8/byte2
	--assert (as byte! 0) = utf8/byte3
	--assert (as byte! 0) = utf8/byte4
	
	--test-- "ucs4-utf8-7"
		utf8: PWAW-ucs4-utf8 0800h
	--assert (as byte! E0h) = utf8/byte1
	--assert (as byte! A0h) = utf8/byte2
	--assert (as byte! 80h) = utf8/byte3
	--assert (as byte! 0) = utf8/byte4
	
	--test-- "ucs4-utf8-8"
		utf8: PWAW-ucs4-utf8 7FFFh
	--assert (as byte! E7h) = utf8/byte1
	--assert (as byte! BFh) = utf8/byte2
	--assert (as byte! BFh) = utf8/byte3
	--assert (as byte! 0) = utf8/byte4
